...
<tags:default-page>
    <jsp:attribute name="title">Polytech Lyon - Add a door</jsp:attribute>
    
    <jsp:attribute name="page_title">Add a door</jsp:attribute>
    ...
    <jsp:attribute name="body_content">
	    ...
	    <script src="${js_door_form}"></script>
    		...
    		<form name="doorForm" method="post" action="/rfid/DoorController/insert" onsubmit="return checkInputs()">
