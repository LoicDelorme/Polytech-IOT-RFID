...
<tags:default-page>
    <jsp:attribute name="title">Polytech Lyon - Add a user</jsp:attribute>
    
    <jsp:attribute name="page_title">Add a user</jsp:attribute>
    ...
    <jsp:attribute name="body_content">
	    ...
	    <script src="${js_user_form}"></script>
    		...
    		<form name="userForm" method="post" action="/rfid/UserController/insert" onsubmit="return checkInputs()">
